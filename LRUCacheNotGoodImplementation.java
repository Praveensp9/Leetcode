...
public class LRUCacheNotGoodImplementation {
	...
	private LRUCacheNotGoodImplementation(int n) {
		lru = new LinkedList<>();
		set = new HashSet<>();
		this.n = n;
	}
	...
	public static void main(String[] args) {
		LRUCacheNotGoodImplementation cache = new LRUCacheNotGoodImplementation(4);
		cache.pageFaults(1);
		cache.display();
		cache.pageFaults(2);
		cache.display();
